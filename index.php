...
<header class="header" style="overflow: hidden;" role="banner">
    ...
    <nav style="float: right;  padding-right: 2em;">
        <ul>
			...
			<?php if(isset($_SESSION['usr'])){echo '<li><a href="address.php">Settings</a><li><a href="hidden/logout.php">Logout</a>';
...
<center>
<br><br><br>
<h1 style="color: white; font-size: 50px;"><b>Most Popular Products</b></h1>
</body>